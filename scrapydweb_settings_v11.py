...
SCRAPYD_SERVERS = [
    os.environ.get('SCRAPYD_SERVERS', 'localhost:6800'),
]
...
LOCAL_SCRAPYD_SERVER = os.getenv('SCRAPYD_SERVERS', 'localhost:6800')
...
SCRAPYD_SERVERS_PUBLIC_URLS = [
    os.environ.get('SCRAPYD_SERVERS_PUBLIC_URL', 'http://localhost/scrapyd'),
]
